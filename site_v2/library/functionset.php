...
function logcheck(){
    if(!isset($_SESSION['username'])){
        header('Location: http://www.csit.parkland.edu/~apetrotte1/csc155/site_v2/login.php');
...
echo <<<'EOT'
    <p style='text-align:right'>
        <img src='http://www.csit.parkland.edu/~apetrotte1/csc155/site_v2/imgs/toaster2.jpg' style='float:right;width:30px;height:30px;'>
...
echo <<<'EOT'
<ul>
    <li><a class="activehead" href="http://www.csit.parkland.edu/~apetrotte1/csc155/site_v2/homepage.php">Home</a></li>
    <li><a href="http://www.csit.parkland.edu/~apetrotte1/csc155/site_v2/p1.php">Page1</a></li>
    <li><a href="http://www.csit.parkland.edu/~apetrotte1/csc155/site_v2/p2.php">Page2</a></li>
    <li><a href="http://www.csit.parkland.edu/~apetrotte1/csc155/site_v2/p3.php">Page3</a></li>
    <li><a href="http://www.csit.parkland.edu/~apetrotte1/csc155/site_v2/p4.php">Page4</a></li>
    <li><a href="http://www.csit.parkland.edu/~apetrotte1/csc155/site_v2/cart.php">Cart</a></li>
    <li><a href="http://www.csit.parkland.edu/~apetrotte1/csc155/site_v2/gbpage.php">Logout</a></li> 
</ul> 
EOT;
}
